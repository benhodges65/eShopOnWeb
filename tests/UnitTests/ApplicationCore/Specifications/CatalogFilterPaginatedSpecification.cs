...
public class CatalogFilterPaginatedSpecification
{
    ...
    private List<CatalogItem> GetTestCollection()
    {
        ...
        catalogItemList.Add(new CatalogItem(1, 1, "Item 1", "Item 1", "Item 1", 1.00m, "TestUri1"));
        catalogItemList.Add(new CatalogItem(1, 1, "Item 1.5", "Item 1.5","Item 1.5", 1.50m, "TestUri1"));
        catalogItemList.Add(new CatalogItem(2, 2, "Item 2","Item 2", "Item 2", 2.00m, "TestUri2"));
        catalogItemList.Add(new CatalogItem(3, 3, "Item 3","Item 3", "Item 3", 3.00m, "TestUri3"));
